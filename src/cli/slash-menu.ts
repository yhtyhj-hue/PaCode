...
export const BUILTIN_SLASH_COMMANDS: SlashMenuEntry[] = [
  ...
  { command: '/new', description: 'Alias for /clear — fresh conversation' },
  ...
  { command: '/bridge', description: 'Bridge status + MCP inventory; /bridge session list|attach' },
  { command: '/voice', description: 'Voice STT: /voice start|stop|status' },
  { command: '/effort', description: 'Set reply budget: /effort low|medium|high' },
  { command: '/vim', description: 'Toggle vi keys: /vim [on|off]' },
